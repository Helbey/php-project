...
<h1 class="text-5xl bg-rose text-white  pt-20 pl-20 pb-10">{{$heading}}</h1>
<div>
...
<img src="{{$movie['image']}}" class="w-64 mr-8 mt-10">
<h1 class="text-3xl text-white_ pl-16 mt-4 mb-4">
    {{$movie['title']}}
  </h1>
  <a href="/movie/{{$movie['id']}}" class="text-lg bg-violin hover:bg-rose text-white_ rounded-xl mb-10 px-4 py-2 ml-14 mt-4">Show more</a>
